...
import { Bell, FileText, Home, Inbox, User } from './Icons';
  ...
  return (
    <div className="min-h-screen bg-[var(--bg)]">
      <div className="mx-auto flex min-h-screen max-w-[430px] flex-col border-x border-[var(--line)] bg-[var(--bg)] shadow-[var(--shadow-2)]">
        ...
        <nav className="fixed bottom-0 left-1/2 z-30 grid w-full max-w-[430px] -translate-x-1/2 grid-cols-4 border-t border-[var(--line)] bg-[rgb(255_255_255_/_0.92)] px-1 pb-5 pt-2 backdrop-blur">
          {tabs.map(tab => {
            const Icon = tab.icon;
